...
type NginxClusterStatus struct {
	...
	// conditions represent the current state of the NginxCluster resource.
...
type NginxCluster struct {
	...
	// spec defines the desired state of NginxCluster
	// +required
	Spec NginxClusterSpec `json:"spec"`

	// status defines the observed state of NginxCluster
	// +optional
	Status NginxClusterStatus `json:"status,omitzero"`
}
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &NginxCluster{}, &NginxClusterList{})
		return nil
	})
}
